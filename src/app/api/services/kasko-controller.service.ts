...
export class KaskoControllerService extends BaseService {
  constructor(
  ...
  sendMsgToMail$Response(params: {
    ...
    const rb = new RequestBuilder(this.rootUrl, KaskoControllerService.KaskoControllerSendMsgToMailPath, 'post');
    if (params) {
